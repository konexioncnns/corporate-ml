...
const Support = () => {
  ...
  <div className="relative pb-32 bg-gray-800">
    ...
    <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        <Typography variant='h1' color="white" fontFamily="Inter-Roman">Contact de nous</Typography>
      <Typography textAlign="center">
      <Typography color="white" fontFamily="Inter-Roman">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames. Dui, amet, nec sit pulvinar.</Typography>
  ...
  <section className="-mt-32 max-w-7xl mx-auto relative z-10 pb-32 px-4 sm:px-6 lg:px-8" aria-labelledby="contact-heading">
    ...
    <div className="flex flex-col bg-white rounded-2xl shadow-xl">
        <div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
          ...
          <h3 className="text-xl font-medium text-gray-900">Contact par Telephone</h3>
        ...
        <div className="p-6 bg-gray-50 rounded-bl-2xl rounded-br-2xl md:px-8">
          <a href="#" className="text-base font-medium text-indigo-700 hover:text-indigo-600">Contact us<span aria-hidden="true"> &rarr;</span></a>
        </div>
      </div>
