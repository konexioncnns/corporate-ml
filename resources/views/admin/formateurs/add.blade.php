...
<div class="col-md-8">
    <div class="card card-danger">
        ...
        <div class="card-body">
            <form action="{{ route('formateur.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row d-flex justify-content-between">
                    <div class="form-group">
                        <label for="title">Nom</label>
                        <input type="text" class="form-control" name="firstname" placeholder="Nom formateur">
                    </div>
                    <div class="form-group">
                        <label for="title">Prénom</label>
                        <input type="text" class="form-control" name="lastname" placeholder="Prénom formateur">
                    </div>
                </div>
                <div class="row d-flex justify-content-between">
                <div class="form-group">
                        <label for="title">Telephone</label>
                        <input type="text" class="form-control" name="phone" placeholder="Prénom formateur">
                    </div>
                    <div class="form-group">
               ...
               <label for=" genre">Genre</label>
                ...
                <div class="row d-flex justify-content-between">
                    <div class="form-group">
                        ...
                        <select name="specialite_id" class="form-control custom-select">
                ...
                <div class="form-group">
                    ...
                    <textarea name="biography_en" class="form-control" rows="4"></textarea>
                </div>
