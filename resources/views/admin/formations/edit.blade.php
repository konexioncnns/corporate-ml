...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Mettre a jour la formation</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Mettre a jour une formation</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <form action="{{ route('formation.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title"  value="{{$form['title']['fr']}}" placeholder="Titre de la formation">
                        </div>
                        <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="form-group">
                                ...
                                <input type="number" name="price" value="{{$formation->price}}" class="form-control">
                            </div>
                    ...
                    <img style="width:60px ;height:60px;" src=" {{asset('img/formations/'.$formation->image)}}" alt="user-avatar"
        ...
        <div class="col-md-6">
            <div class="card card-danger">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="title">Titre de la formation</label>
                        <input type="text" class="form-control" name="title_en" value="{{$form['title']['en']}}" placeholder="Titre de la formation">
                    </div>
                    <div class="form-group">
                        <label for="inputDescription">Description de la formation</label>
