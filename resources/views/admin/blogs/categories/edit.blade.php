                ...
                <div class="card-body">
                    <form action="{{ route('category.update') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $category['title']['fr'] }}" name="title" placeholder="Titre du categorie">
                        </div>
                        <div class="form-group">
            ...
            <div class="card card-danger">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $category['title']['en'] }}" name="title_en" placeholder="Titre du domaine">
                    </div>
                    <div class="form-group">
